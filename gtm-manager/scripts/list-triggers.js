...
const HELP = `
List all triggers in a GTM container.

Usage:
  node list-triggers.js --account <id> --container <id> --credentials <path> --token <path>
...
Output:
  JSON array of triggers with id, name, and type
`;
